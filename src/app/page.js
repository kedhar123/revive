    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mt-16">
          {/* <button className="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white font-bold py-4 px-8 rounded-full text-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
            Get Started with Revive
          </button> */}
          {/* <p className="text-gray-500 mt-4">
            Join thousands of users making eco-conscious choices
          </p> */}
        </div>
      </div>
